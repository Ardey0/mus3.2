...
public class Lift {
    ...
    private static double kP = 0.045, kI = 0.03, kD = 0.0001, kF = 0.00008;
    ...
    public Lift(@NonNull HardwareMap hardwareMap) {
        ...
        this.encoder = hardwareMap.get(DcMotorEx.class, "frontRight"); // de schimbat in motorul cu encoderul
